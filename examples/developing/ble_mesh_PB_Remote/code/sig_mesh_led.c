...
static mesh_model_t light_models[] =
{
    ...
    [15] = /*Generic Level*/
    {
        .model_id = GENERIC_LEVEL_SERVER_MODEL_ID,
        .model_vendor = false,
        .element_idx = MESH_ELMENT_SATURATION,
        .msg_handler = generic_level_server_msg_handler,
    },
    ...
    [17] =
    {
        ...
        .model_vendor = true,
        .element_idx = MESH_ELMENT_MAIN,
        .msg_handler = blob_transfer_server_msg_handler,
    },
    ...
    [18] =
    {
        ...
        .model_vendor = true,
        .element_idx = MESH_ELMENT_MAIN,
        .msg_handler = firmware_update_server_msg_handler,
    },
#endif
};
...
static void mesh_callback_func(mesh_event_t * event)
{
    ...
    switch(event->type)
    {
        ...
        case MESH_EVT_PROV_RESULT:
            ...
            {
				APP_MESH_Provision_Complete();
				//os_timer_start(&sig_mesh_prov_timer, 30000, false);
            }
			else
			{
				co_printf("PROV ERROR\r\n");
                platform_reset_patch(0);
			}
            break;
