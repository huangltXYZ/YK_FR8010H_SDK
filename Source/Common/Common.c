...
inline U16 co_read16p(void const *ptr16)
{
    uint16_t value = ((uint8_t *)ptr16)[0] | ((uint8_t *)ptr16)[1] << 8;
    return value;
}

inline U32 co_read32p(void const *ptr32)
{
...
{
    uint16_t us_100_unit;
    uint16_t i;
    for(us_100_unit = 0; us_100_unit < us_100; us_100_unit++)
    {
        for(i = 0;i < 432; i++);
    }
}
